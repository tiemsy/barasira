        ...
        <div class="missions">
            ...
            <div class="missions-container">
                ...
                <div v-for="mission in missions" :key="mission.id" class="mission-card">
                    ...
                    <div class="dates" :class="getDurationColor(mission.date_start, mission.date_end, mission.status)">
...
function getDurationColor(start, end, status) {
    const d1 = new Date(start)
    const d2 = new Date(end)
    const diffDays = (d2 - d1) / (1000 * 60 * 60 * 24)

    if (status === "pending") return "date_pending"
    if (status === "in_progress") return "date_in_progress"
    if (status === "completed") return "date_completed"
