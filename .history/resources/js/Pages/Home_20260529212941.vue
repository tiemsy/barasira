<template>
    <AppLayout>
        <div class="home-page">
            ...
            <!-- MISSIONS -->
            <section v-if="missions.length" class="section-missions">
                <div class="container">

                    <div class="section-missions__header">
                        ...
                        <div>
                            ...
                            <p class="section-subtitle">
                                Découvrez les dernières missions publiées et postulez rapidement.
                            </p>
                        </div>

                        <Link href="/missions" class="btn btn-outline">
                    ...
                    <div class="missions-grid missions-grid--premium">
                        <MissionCard v-for="mission in missions.slice(0, 4)" :key="mission.id" :mission="mission" />
                    </div>
                ...
                <div class="container">
                    ...
                    <div class="home-cta-card">
                        ...
                        <div class="home-cta-content">
                            ...
                            <h2>
                                Lancez votre activité et trouvez vos premiers clients
                            </h2>

                            <p>
                                Créez votre profil, publiez vos services et recevez des demandes de clients partout au
                                Mali.
                            </p>
                            ...
                            <div class="home-cta-actions">
                                ...
                                <Link href="/services" class="btn btn-outline">
                                    Voir les services
                                </Link>
                            </div>
                        ...
                        <div class="home-cta-visual">

                            <div class="home-cta-icon-card home-cta-icon-card--one">
                                <i class="bi bi-person-check"></i>
                                <span>Profil vérifié</span>
                            </div>

                            <div class="home-cta-icon-card home-cta-icon-card--two">
                                <i class="bi bi-briefcase"></i>
                                <span>Missions</span>
                            </div>

                            <div class="home-cta-icon-card home-cta-icon-card--three">
