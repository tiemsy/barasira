 ...
 *
 * @OA\Post(path="/api/missions/{id}/applications", operationId="missionApplications.store", tags={"Mission applications"}, security={{"sanctum":{}}}, description="Permet à un prestataire de postuler à une mission disponible avec un tarif horaire ou un forfait global. Une candidature est refusée si elle chevauche une autre mission ou candidature active sur le même créneau.", @OA\Parameter(ref="#/components/parameters/Id"), @OA\RequestBody(required=true, @OA\JsonContent(ref="#/components/schemas/MissionApplicationRequest")), @OA\Response(response=201, description="Candidature créée et client notifié", @OA\JsonContent(ref="#/components/schemas/MissionApplicationResponse")), @OA\Response(response=403, ref="#/components/responses/Forbidden"), @OA\Response(response=422, ref="#/components/responses/ValidationError"))
 * @OA\Post(path="/api/missions/{id}/applications/{application}/accept", operationId="missionApplications.accept", tags={"Mission applications"}, security={{"sanctum":{}}}, description="Le client propriétaire sélectionne une candidature. La mission passe en cours, les autres candidatures sont refusées et le prestataire retenu reçoit une notification interne, un e-mail et un message WhatsApp.", @OA\Parameter(ref="#/components/parameters/Id"), @OA\Parameter(name="application", in="path", required=true, @OA\Schema(type="integer", minimum=1)), @OA\Response(response=200, description="Candidature acceptée et mission attribuée"), @OA\Response(response=403, ref="#/components/responses/Forbidden"), @OA\Response(response=422, ref="#/components/responses/ValidationError"))
