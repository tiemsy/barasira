            ...
            <form class="admin-user-form-card" @submit.prevent="submit">
                <section>
                    ...
                    <div class="admin-user-form-grid">
                        ...
                        <label><span>{{ $t('adminServices.icon') }}</span><input v-model.trim="form.icon" maxlength="100" placeholder="fas fa-tools"><small v-if="form.errors.icon">{{ form.errors.icon }}</small></label>
